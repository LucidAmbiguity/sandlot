...
class GivePermissionToRoleController extends Controller
{
    ...
    {
        // dd($request);
        $role = Role::find($request->role)->givePermissionTo($request->permissionId);
        // dd($role);
    ...
    {
        Role::find($request->roleId)->revokePermissionTo($id);
